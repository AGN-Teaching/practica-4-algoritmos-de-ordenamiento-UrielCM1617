...
int main(int argc, char * argv[]) {
    if (argc != 3) {
        cout << "\nSintaxis: ordenamiento <tamaÃ±o_arreglo> <nÃºmero_arreglos_a_generar_y_ordenar>\n" << endl;
    } else {
        ...
        cout << "\n\tTAMAÃ‘O DE ARREGLOS: " << TAM_ARREGLO <<"\tNUMERO DE ARREGLOS: " << NUM_ARREGLOS << endl;
        ...
        for (int i = 0; i < NUM_ARREGLOS; i++)
        {
            ...
            cout << "\nCreando arreglo aleatorio de tamaÃ±o " << TAM_ARREGLO << "...";
